...
class ProfileDataController extends GetxController {
  ...
  void onInit() {
    ...
    accountSettingList.add(
      ProfileFeatureModel(
        title: AppString.analytics, leadingImage: IconAsset.analystic,
        onTap: () {
...
///business list
    businessSettingList.add(
      ProfileFeatureModel(
          title: AppString.businessListing, leadingImage: IconAsset.listing,onTap: (){
    ...
    businessSettingList.add(
      ProfileFeatureModel(
          title: AppString.businessMenu, leadingImage: IconAsset.menu,onTap: () {
        Navigation.pushNamed(Routes.businessMenu);
          },),
    );
    businessSettingList.add(
    ...
    businessSettingList.add(
      ProfileFeatureModel(title: AppString.queries, leadingImage: IconAsset.queries),
    );
///other list
    othersSettingList.add(
      ProfileFeatureModel(
          title: AppString.helpCenter, leadingImage: IconAsset.help),
    );
    othersSettingList.add(
      ProfileFeatureModel(
          title: AppString.privacyPolicyCamelCase, leadingImage: IconAsset.policy),
    );
    othersSettingList.add(
      ProfileFeatureModel(
          title: AppString.termsConditionsCamelCase, leadingImage: IconAsset.terms),
    );
///login list
    loginSettingList.add(
      ProfileFeatureModel(
          title: AppString.userLogin, leadingImage: IconAsset.logOut),
    );
    loginSettingList.add(
      ProfileFeatureModel(
          title: AppString.logOut, leadingImage: IconAsset.logOut),
    );
  }
