                    ...
                    if (loginController.emailController.text.isNotEmpty &&
                      ...
                      if (loginController.formKey.currentState!.validate()) {
                        ...
                        (splashController.isVandor.value)
                            ? Navigation.replace(Routes.vanDorDashBoard)
                            : Navigation.replace(Routes.userDashBoard);
                        print("vanDor Value ----> Splash to redirect ---> ${splashController.isVandor.value}");
                        (splashController.isVandor.value)
                            ? print("Login to vanDor ---> vanDorDashBoard")
                            : print("Login to user ---> userDashBoard");
                      }
                    }
                  },
                  ...
                  children: [
                    SocialButtonWidget(
                      onTap: () {
                        ...
                        print(
                            "vanDor Value ----> LogIn to redirect phoneNumber---> ${splashController.isVandor.value}");
                      },
