          ...
          child: Column(
            ...
            children: [
              ...
              GestureDetector(
                ...
                child: Container(
                  height: 52.h,
                  decoration: BoxDecoration(color: AppColors.whiteColor.withOpacity(0.1), borderRadius: BorderRadius.circular(8.r)),
                  child: Row(
...
// import 'package:flutter_screenutil/flutter_screenutil.dart';
// import 'package:get/get.dart';
// import 'package:local/modules/authentication/signup/controller/business_address_controller.dart';
// import 'package:local/utils/app_colors.dart';
// import 'package:local/utils/app_string.dart';
// import 'package:local/utils/assets.dart';
// import 'package:local/utils/navigation_utils/navigation.dart';
...
//   final BusinessAddressController businessAddressController = Get.put(BusinessAddressController());
//
//   @override
//   Widget build(BuildContext context) {
//     return Container(
...
//                 fontSize: 12.sp,
//               ),
//               // if (businessAddressController.currentAddress.isNotEmpty)
//               GetBuilder<BusinessAddressController>(
//                 init: BusinessAddressController(),
//                 builder: (controller) => businessAddressController.currentAddress.isNotEmpty
//                     ? CommonText(
//                         text: businessAddressController.currentAddress.value,
//                         fontWeight: FontWeight.w500,
//                         fontSize: 12.sp,
//                         color: AppColors.bodyDark,
//                       ).paddingOnly(top: 10.h, bottom: 13.h)
