...
class ChatViewScreen extends StatelessWidget {
   ...
   ChatDataController _chatDataController =Get.put(ChatDataController());
            ...
            Container(
              ...
              child: Text(
                ...
                style: TextStyle(
                    ...
                    color: chatDataModel.messageType == AppString.receiver ? AppColors.white : AppColors.lightGrey2),
              ),
            ),
          ],
        ),
