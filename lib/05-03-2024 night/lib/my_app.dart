...
import 'modules/vendor/businessdetails/controller/restaurant_menu_controller.dart';
import 'modules/vendor/businessdetails/controller/restaurant_photos_controller.dart';
import 'modules/vendor/dashboad/view/profile/presentation/payment/controller/payment_data_controller.dart';
...
class AppBidding extends Bindings {
  ...
  void dependencies() {
    ...
    Get.put(RestaurantPhotoController());
