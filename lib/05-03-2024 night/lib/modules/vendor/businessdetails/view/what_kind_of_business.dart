                    ...
                    return Column(
                      ...
                      children: [
                        ...filteredSubServices.map((subService) {
                          bool isSelectable =
                              whatKindOfBusinessController.selectedKey.isEmpty || whatKindOfBusinessController.selectedKey.contains(key);
                          bool isSelected = whatKindOfBusinessController.selectedServices.contains(subService);
                          ...
                          return InkWell(
                              onTap: isSelectable
                                ...
                                print("isDisplay.value ---> ${whatKindOfBusinessController.isDisplay.value}");
                                whatKindOfBusinessController.isDisplay.value = false;
                                print("isDisplay.value ---> ${whatKindOfBusinessController.isDisplay.value}");
                              }
                                  : null, // Disable onTap if not selectable
                              child: Text(
                                "$key - $subService",
                                style: TextStyle(
                                  fontSize: 16.0,
