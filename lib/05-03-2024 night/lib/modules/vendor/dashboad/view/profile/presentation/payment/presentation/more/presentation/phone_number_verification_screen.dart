...
import 'package:local/modules/vendor/dashboad/view/profile/presentation/payment/presentation/more/controller/phone_verify_controller.dart';
                      ...
                      child: pinPutOTPController.isResendEnabled.value
                          ...
                          : RichText(
                              text: TextSpan(
                                  ...
                                  TextSpan(
                                    text:
                                        '${pinPutOTPController.getFormattedTime(pinPutOTPController.resendDelayInSeconds.value)} Sec',
                                    style: TextStyle(
