              ...
              child: Column(
                ...
                children: [
                  Row(
                    ...
                    children: [
                      CommonText(text: AppString.yourRestaurantName, fontSize: 22.sp),
                      GestureDetector(
                        onTap: () {
                  ...
                  CommonText(text: AppString.bengaluru, fontSize: 12.sp).paddingSymmetric(horizontal: 16.w),
                  20.h.verticalSpace,
                  Container(
                        ...
                        return Row(
                          ...
                          children: [
                            if (index.isEven && index != 0)
                              const VerticalDivider(width: 1, color: Colors.grey).marginOnly(right: 35.w),
                            RestaurantOrder(
                              orderTime: _homeScreenController.orderTimeList[index].toString(),
                              orderPrice: _homeScreenController.orderPriceList[index].toString(),
                              orderQuantity: _homeScreenController.orderQuantityList[index].toString(),
        ...
        child: Column(
          ...
          children: [
            ListTile(
              ...
              title: CommonText(text: queryDataModel.user ?? "", fontSize: 12.sp),
              subtitle: CommonText(
              ...
              trailing: PopupMenuButton<String>(
                icon: SvgPicture.asset(IconAsset.verticalMore),
                onSelected: (String value) {
                  if (value == 'Reply') {
                    Get.toNamed(
                      Routes.vandorHomeChat,
                      arguments:  queryDataModel,
                    );
            ...
            CommonText(text: queryDataModel.msg ?? "", fontSize: 16.sp, fontWeight: FontWeight.w500)
            ...
            if ((queryDataModel.replyList ?? []).isNotEmpty)
              ListView.builder(
                ...
                itemCount: queryDataModel.replyList?.length,
                itemBuilder: (context, index) {
                  return Column(
                    mainAxisSize: MainAxisSize.min,
                    children: [
                              ...
                              child: Column(
                                ...
                                children: [
                                  ListTile(
                                    ...
                                    title: CommonText(
                                        text: queryDataModel.user ?? "", fontSize: 12.sp, fontWeight: FontWeight.w500),
                                    subtitle: CommonText(
                                      text: queryDataModel.time ?? "",
                                      fontSize: 10.sp,
                                  ...
                                  CommonText(
                                    text: queryDataModel.replyList![index],
                                    color: AppColors.bodyDark,
                                    fontSize: 12.sp,
                                    fontWeight: FontWeight.w400,
                                  ).paddingOnly(bottom: 16.h, right: 12.w),
                                ],
                              ),
                            ),
                          ],
