...
import 'package:local/modules/vendor/dashboad/view/controller/vandor_home_chat_controller.dart';
                    ...
                    child: Column(
                      ...
                      children: [
                        ListTile(
                          ...
                          title: CommonText(
                              text: argument.user ?? "", fontSize: 10.sp),
                          subtitle: CommonText(
                            text: argument.time ?? "",
                            fontSize: 8.sp,
                            color: AppColors.middleGrey,
                        ...
                        // 5.verticalSpace,
                        Text(argument.reply ?? "",style: TextStyle(color: Colors.white),),
                      ],
                    ),
                  ),
                ],
