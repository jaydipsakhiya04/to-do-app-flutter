...
import 'package:local/modules/vendor/dashboad/view/controller/home_screen_controller.dart';
...
import '../../controller/vandor_home_chat_controller.dart';
      ...
      child: Container(
        child: Column(
          ...
          children: [
            ...
            if ((queryDataModel.reply ?? "").isNotEmpty)
              IntrinsicHeight(
                child: Row(
                  children: [
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ListTile(
                            ...
                            title: CommonText(
                                text: queryDataModel.user ?? "", fontSize: 10.sp),
                            subtitle: CommonText(
                              text: queryDataModel.time ?? "",
                              fontSize: 8.sp,
                              color: AppColors.middleGrey,
                          ...
                          // 5.verticalSpace,
                          Text(queryDataModel.reply ?? "",style: TextStyle(color: Colors.white),),
                        ],
                      ),
                    ),
                  ],
