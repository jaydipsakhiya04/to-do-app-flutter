...
class BusinessFeaturesScreen extends StatelessWidget {
  BusinessFeaturesScreen({Key? key}) : super(key: key);
    ...
    return Container(
      ...
      child: Scaffold(
        ...
        body: Column(
          ...
          children: [
            CommonText(
              text: AppString.businessFeatures,
            ...
            CustomButton(
              onTap: () {
                Navigation.pushNamed(Routes.businessEcoFriendly);
              },
